...
This static reader publishes **Chapters 1–82** from `Peg_Leg_Greg_authoritative_ch82_light_edit(1).docx`.

The manuscript remains the prose authority. This reader is a derived publishing build.

## Current source

- Manuscript: `Peg_Leg_Greg_authoritative_ch82_light_edit(1).docx`
