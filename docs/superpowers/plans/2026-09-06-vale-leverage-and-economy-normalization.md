# Vale Leverage + Economy Normalization Implementation Plan
...
**Spec:** `docs/superpowers/specs/2026-09-06-vale-leverage-and-economy-normalization-design.md`

## Global Constraints

- Zero invented copper/silver/gold conversion.
- Preserve story structure wherever arithmetic allows.
...
- No mass prose rewrite.

---

### Task 1: Durable Vale Lending Authority

**Files:**
- Create: `state/editorial/economy-normalization/VALE_LEVERAGE_MODEL.md`
...
- [ ] Re-fetch all three authority surfaces and verify wording.

### Task 2: Early Vale / Tere Continuity Overlay

**Files:**
- Modify: `state/editorial/economy-normalization/EARLY_VALE_LEDGER.md`
- Create: `state/editorial/economy-normalization/VALE_NUMERIC_REPAIR_QUEUE.md`

**Produces:** explicit repair instruction for the Ch7 5s / Ch10 10s contradiction and early running ledger.

- [ ] Preserve Chapter 7's 5s Tere negotiated principal.
...
**Files:**
- Modify: `state/editorial/economy-normalization/REPRESENTATIVE_EARNINGS_AUDIT_01.md`
- Modify: `state/editorial/economy-normalization/FORWARD_EARNING_LADDER.md`
- Modify: `state/editorial/economy-normalization/CURRENT_NUMERIC_OVERLAY.md`

**Produces:** approved patch targets and a forward rule preventing copper-scale regression.

- [ ] Lock Ch471 low-silver target.
- [ ] Lock Ch473 whole-transaction gray-freight raise.
- [ ] Lock Ch475 low/mid-silver target.
- [ ] Lock Ch484 transaction+commission raise.
- [ ] Lock Ch485-486 tens-of-silver organizer target.
- [ ] Lock Ch490 meaningful-silver contract target.
- [ ] Preserve Ch319 and Ch488 copper/token pay.
- [ ] Keep gold occasional and earned.
- [ ] Re-fetch and verify the ladder remains relative, not a wage table.

### Task 4: Build Recent-Chain Numeric Patch Map

**Files:**
- Create: `state/editorial/economy-normalization/RECENT_CHAIN_PATCH_MAP.md`
- Read exact: Chapters 471-491 relevant economic checkpoints.

**Produces:** one dependency-aware replacement map before prose edits.
...
**Files:**
- Modify exact manuscript checkpoint files identified by Task 4, prioritizing:
...
- [ ] Current `main` is freshly fetched and reported.
