# Greg, Again - Chapter 9 Audio Finish

Chapter: **009 - The Backstop**
Written source header: **Chapter 9: The Bridge**
Source authority: `r2/assets/written/ch009.md`
Voice: `deep`
...
- Greg remembers a later stone bridge here.
- The current bridge is wooden, the approach is failing, and his future answer does not contain the missing history.

During the wagon rescue, processing space must also preserve action ownership and load direction. Meral owns the broad ward and the core rescue commands. Jorren reads the trapped team and frees the driver. Greg's contribution is small and specific: he keeps the rear rope from walking up the wet post, then corrects the plane angle under load.

The chapter-specific listening grammar is:
