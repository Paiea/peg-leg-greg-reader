...
Speculative-origin prose must be challenged for **experiential completeness**, not merely causal correctness.

Ask:

> **What would be lost if I only read the synopsis?**

A short chapter may still be complete. A long chapter may still be treatment-like. Do not use word count as the test.

Classify publication-side prose as:

- `SOURCE WIN` — the chapter already feels fully lived at normal R2 listening fidelity.
...
## Connected-listen challenger

Do not judge every chapter in isolation. Audit approximately **6–8 connected chapters** as a listening run before editing individual units.
