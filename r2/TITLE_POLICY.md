...
R2 chapter titles are role titles.

## Core question

Every selected/public R2 chapter title should answer:
...
That selected role title propagates to:

1. `r2/data/chapters/chNNN.json`
2. `r2/data/chapter-registry.json`
3. `greg-again/audio/manifest.json` when audio exists
...
Use `r2/TITLE_ROLE_AUDIT.md` for current approved decisions and `scripts/sync_r2_role_titles.py` for title parity.
