# BREN 220A–220C CANON STATE

## Status

Chapters **220A — THE SHORTAGE**, **220B — THE OLD MAN**, and **220C — THE ROUTE** are canonical inserted chapters between Chapter 220 and Chapter 224.

They do **not** renumber Chapter 224 or any later chapter.

Canonical exact prose:

- `state/manuscript/Peg_Leg_Greg_Chapter_221_EXACT.md`
- `state/manuscript/Peg_Leg_Greg_Chapter_222_EXACT.md`
- `state/manuscript/Peg_Leg_Greg_Chapter_223_EXACT.md`
...
The confrontation also establishes a clearer on-page memory pattern: Greg can retrieve a deeply practiced procedural lesson from his first life while failing to retrieve the name attached to the autobiographical memory. This supports the durable rule that repeated-use / embodied / operational knowledge tends to survive more reliably than incidental identifiers or directly searchable personal detail. Personal and emotional memory are not erased.
...
The **local Bren extortion pressure against the theatre and its immediate supplier network** is resolved/dormant after 220C unless independently reactivated by later story causality.
...
The inserted chapters do not add supervised mana draws, shaping attempts, or external-effect attempts.
...
Therefore Chapter 224's Hessa note, supervised far-distance work, and existing magic counts remain valid after 220C.
...
**220 inquiry/network awareness → 220A material cost → 220B deliberate bluff/withdrawal → 220C systemic friction and ordinary route restoration → 221 return to other life/work/magic.**

Do not compress the four-part progression back into an unresolved fadeout. Do not inflate it into a combat climax.
