# PEG-LEG GREG — CHARACTER BIBLE

Durable character knowledge for writers/editors. Manuscript evidence outranks this file. Store what future workers repeatedly need; do not turn this into biographies.
...
- Chapter 228–229 establishes paid customer-requested rework at the narrow behavioral level: the brown-cuff customer changes the cuff after completion, changes it again, Lyssa charges for both changes, delivers the job, gets paid, hears that the first cuff was prettier, and moves on.
...
- Central to supervised mana testing, evidence discipline, safety, repeatability, apparatus, and narrow claims.
- Not Greg's theatrical illusion teacher.
- Her value is partly methodological: what can actually be claimed from the evidence?
- Do not flatten her into a generic magical mentor who rewards every interesting result with expanded permissions.

## Rinna

- Theatre authority/organizer in the current pressure arc.
...
- Chapter 225–228 establishes accumulated material memory around Marek's object habits: specific props are kept from him, the striped umbrella returns wet and requires drying, protected stage property gets active custody, and the painted cup is stopped/inspected after he uses it for water.
...
- Nessa, Hara, and other workers have material social memory around this behavior. Chapter 225–228 shows it creating actual downstream work or preventative adjustment: umbrella hunting/drying, object repositioning, protected property handling, reset/reorganization, and painted-cup inspection.
...
- Probable name of close-haired, heavy-coat spokesman in the current pressure arc.
- Left glove; tends to hold that hand closer.
- Chapter 218 directly demanded one copper from theatre; Rinna refused; he warned next time would not be one.
- No surname, boss, organization, or larger structure established.
- Do not promote suspected connections into fact.

## Brown-coat observer / questioner

- Thin-faced man, brown coat, dark hair, quiet voice.
- Description matches prior Copper Kettle observer.
- Has asked suppliers about theatre money/business and caused practical interference.
- Identity, employer, relationship to Bren, and organization remain unproved.
