...
Do not turn each batch into a manuscript-wide visual audit.

## 5x5 contact-sheet default

One contact sheet = approximately **25 independently usable panels**.

Each cell should be conceived as its own illustration, not one continuous 25-panel scene.
...
3. read the relevant authoritative manuscript scenes
4. select distinct visual moments
5. construct panel prompts using the visual bible
6. generate 5x5 sheet
7. review cells with loose production-first KEEP/RETRY standard
8. crop KEEP panels deterministically
9. record manifest
10. integration script skips RETRY
11. place KEEP art at nearest natural paragraph break
...
- unusual camera opportunity
- relationship action rather than posed conversation
- meaningful props
- magic with directional force
- comedy/recovery
...
- lighting/weather where manuscript supports it

## Manifest

Each batch should retain deterministic mapping between:
- sheet
- panel number
- chapter
- manuscript moment
- status KEEP/RETRY
- output filename
- insertion location or paragraph anchor
...
Accept normal variation in facial proportions, rendering detail, clothing folds, lighting, and style texture.

Retry major continuity/anatomy/manuscript failures only. See `state/VISUAL_BIBLE.md`.
...
- KEEP / RETRY
- chapters improved
- zero/one/two/three+ image counts when available
- major continuity problems
- next 25 slots

Leave a fresh-worker re-prompt that points back to GitHub state rather than embedding the entire batch history.