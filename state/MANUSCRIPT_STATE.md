...
## Endpoint
- Current exact story endpoint: Chapter 320 - **THE PORTRAIT**.
...
- Exact Chapters 249-320 are durable checkpoint files under `state/manuscript/`; exact prose outranks summaries. Older synchronization debt remains. Never reconstruct exact prose from summaries.
...
- Reduced liquidity should matter naturally. Do not instantly restore it through convenient work, refund, lucky resale, pity, art sale, or holdfast payoff.
...
- Crutches, right shoe, bag, stay bead, hands, right leg, and balance remain sound through Ch320.
...
- Fixed holdfast remains wrapped on high shelf above Greg's clothes, ring sideways, base on sailcloth, out of Tavi's reach, warning tag `DO NOT TURN RING.` No activation/handling through Ch320.
- Ch310 unnamed load-vest customer / Jari / blue-line work remains Lyssa's bounded job. Ch320 explicitly shows Lyssa trimming something dark that is **not** the green vest; Greg does not investigate.
...
- Ch313-Ch320 add no Greg magic attempts. Environmental/item magic does not count as Greg mana use.
...
- Ch306-Ch320 contain no mirrorhorn/ecology follow-up. Do not turn magical ecology into creature-of-the-week progression.
...
- Neris's cupboard reaches third floor through cooperative turning space. No repair/job/payment.
...
- Ch299-Ch305 bounded uncertainties remain bounded, including mirrorhorn implementation beyond observed behavior.
...
## Chapter 321 trailhead
Follow the next actual claim from current authority.

Let Chapter 320's portrait beat stand as a fresh piece of social accumulation. Do not automatically make Senna a recurring best friend, official artist, portrait seller, sign-job source, reputation engine, theatre poster artist, or route into paid work. Do not have Greg buy the portrait next chapter merely because he wanted it. Bel's gossip remains partial and ordinary.
...
Let Ch319's missed one-copper offer remain missed. Do not compensate Greg immediately with another cash task, pity coin, refund, appraisal windfall, holdfast payoff, art-related income, or guaranteed Vale work.

Do not automatically make Chapter 321:
- another portrait/Senna/Bel chapter,
- a haircut chapter just because several people mocked Greg's hair,
