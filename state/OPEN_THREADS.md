...
- Ch304 advanced magic through cleaner observation, not greater force/range.
- Ch305 gives Greg one high-confidence fieldcraft success without creating a handler role.
- Ch306 opens one concrete magical-item/capital lane through a consequential two-copper fixed-holdfast purchase whose payoff remains unproved.
- Ch307 lets those engines breathe through an ordinary household evening.
- Ch308 reactivates Vale through one optional one-hour debt-credit task. Greg earns exactly one copper of debt credit while his private purse remains one copper + one bit.
- Ch309 adds environmental magical fantasy through an ordinary charge-rain interruption. Greg knows broad charge-weather safety; local Carrow workers own the local grounding, shelter, and bell procedures.
...
- Sevren's courier bag remains an old working object with a darker replacement flap, pale restitching, and old brass buckle. His hair is longer, face thinner, and a healed cut crosses the bridge of his nose. Cause of the cut is unestablished.
- Sevren offers Greg the empty front seat on a freight-paid cart to **Three Wells** on the east road. Outbound and return freight already cover the cart.
- Sevren explicitly needs no carrying, delivery, signing, work, or problem solving from Greg.
- Greg tells Cala, packs water, two pieces of household bread, existing narrow scrap/charcoal, and one folded seat cloth. Fixed holdfast stays home.
- Sevren matches Greg's pace naturally and does not touch his crutches. This is accumulated relationship/body familiarity, not a new accommodation event.
- Freight-yard east entrance has changed in the last roughly three or four months according to Sevren: a wider gate is now used; old gate remains partly blocked by wheel rims. Exact construction/ownership history unestablished.
- Current carter is **Ressa**, broad woman in brown vest. Relationship to Sevren beyond this run unestablished.
- Ressa instructs that Greg's crutches go beneath the front bench in an existing leather loop rather than across the seat. She checks the strap, not Greg's body.
- Greg boards using right foot/iron step/cart frame, left knee clear. He pads the back of left thigh/residual limb with the folded cloth based on prior road experience.
- At Carrow east gate, a clerk touches a small brass witness bead beside Ressa's name on a cart board; it flashes green. Greg recognizes the broad transfer-mark family. Exact mechanism/authority unestablished.
- East-road texture observed: cabbage fields, recent rain, shallow irrigation channels, square control stones with dull blue faces when water pressure holds and gray when closed. Greg knows broad family; exact local implementation unexamined.
- Greg can now spend attention on road and scenery because cart-body management is more familiar. No new injury or body problem develops.
- **Three Wells** is narrowly established as a road knot: one inn, one stable yard, one long low relay house with blue roof, three stone wells around packed yard. Population/governance/ownership unestablished.
- Current passenger meal at the inn is included with the courier seat. Greg checks before eating. No fare, debt, or reimbursement follows.
- Sevren completes his handoff independently and returns with a dark round wooden proof token crossed by a thin silver line. Greg knows broad relay-token logic but does not touch/investigate it.
- Sevren's work has shifted toward east-road relays after two regulars left. One unnamed regular married into a mill family. One unnamed regular broke a wrist and chose paper work. They remain unbound.
- Sevren says east work pays better and beds are worse. No exact wage, employer, contract terms, formal title, or route authority established.
- Sevren says he previously came by Greg's lodging twice, once while Greg was at theatre and once while Cala said Greg was at Guild. No missed message, grievance, or obligation forms.
- Sevren states current rhythm only: in Carrow that night, east again next day, roughly three days if wheels remain round, then one or maybe two days in Carrow. Not a permanent guaranteed schedule.
- Sevren asks whether Greg wants him to ask about a future **longer east-loop passenger seat** if one actually appears. Greg says `Ask.` No current offer/seat/date/trip is created.
- Sevren says longer passenger seat is usually one bit when not already covered and sometimes free if freight already covers it. No universal fare rule established.
- Return freight is four wrapped wicker panels and two sacks smelling of dried mint. Greg does not inspect/handle it.
- A small amber brake bead flashes once when Ressa uses the long brake lever on a rise. Ordinary item magic only; no problem/investigation.
...
- The customer remains unnamed. She is broad-shouldered, dressed for physical work, and brings a dark green load vest plus a dense squat test sack.
- The vest has two glass-blue load lines from upper back toward the side panels and flat brass beads near their lower ends.
- Greg broadly recognizes the load-vest/load-line family from first-life caravan, casualty, porter, climbing, and military use. He has user/field experience, not tailoring/charm-seam professional expertise.
- Under load the blue lines brighten and the brass beads warm from brown to gold. The vest tightens and pulls hard at the customer's left underarm.
- Customer says `Jari` changed the vest three weeks earlier, before the thicker current shirt. Jari's identity, occupation, relationship, exact alteration scope, and any causal responsibility remain unestablished.
- Lyssa identifies an ordinary cloth constraint beside the existing charm line and repeatedly keeps her scope to cloth.
- Customer asks whether Lyssa can move the blue line. Lyssa says no.
- Customer says Lyssa fixed a prior red carry coat; Lyssa says she worked the cloth and left its line in place. The red carry-coat customer/job history is otherwise unestablished.
- Customer offers another bit for moving/cutting the blue line. Lyssa refuses the work and the extra bit.
- Lyssa accepts the ordinary cloth alteration for exactly **one bit**. Pickup is stated as tomorrow before first bell.
- The customer places one bit on the table. Lyssa later stores it in her own small wooden work box. Nothing makes that coin Greg's or household money.
- The chapter does not show final pickup, final fit, customer satisfaction, refund, repeat work, charm-line repair, or specialist referral outcome.
- After the customer asks Greg whether he knows the gear, Lyssa initially answers `No`; Greg contradicts her and says he broadly does.
- Greg gives several plausible observations about cloth/line/anchor interaction. Lyssa warns him, then tells him `Be finished.`
- Customer leaves amused. No customer/Greg relationship or referral follows.
- Afterward Greg says Lyssa could have charged two. The argument reveals both pride and scarcity rather than a hidden technical revelation.
- Lyssa frames the problem around ownership and return risk: it is her customer, her work, her table for the fitting, and if the blue fails under load the customer comes back to her.
- Lyssa says she knows cloth, knows enough about the blue not to cut it, does not want every job, and does not want line work simply because another bit exists.
- Greg explicitly names his own liquidity pressure: two copper tied up in the fixed holdfast, Vale debt credit not cash, one copper + one bit liquid.
- Lyssa says `Then notice mine is not yours.` This is relationship/economic friction, not a breakup, new household-finance rule, or transfer of money.
- Lyssa temporarily bastes more room into the ordinary cloth and tests the vest with the customer's sack against a chair.
- Greg helps only with test logistics: rather than carrying the dense sack one-handed on crutches, he uses a crutch hook to slide it roughly two feet and Lyssa lifts it onto the chair.
- The temporary adjustment gives more room at the arm but lower pull remains. Lyssa says the cloth can give more lower. Final result remains unseen.
- The blue line is never cut, moved, or repaired in Ch310.
- Greg goes upstairs, sees the wrapped fixed holdfast, and looks at the Vale receipt. He activates neither thread and changes no money/debt state.
...
- Local Carrow preparation observed before rainfall: black braided grounding cords lowered toward gutters/curb paths, bright charm signs shuttered, canvas lowered, and goods moved away from exposed metal.
- One long brass-bell note is locally called `First`. A later two-short-note signal coincides with people taking shelter as the rain begins.
- Greg takes the nearer bakery loading arch instead of racing for farther cover on wet stone.
- Shelter group remains unnamed: courier woman, two handcart men, woman with baby, bakery worker, older man, Greg.
- Bakery worker owns local procedure: grounding cord, `Nothing bright out`, and gray-ash ceramic dish for misbehaving charms.
- Greg's stay bead remains dark, cool, and quiet.
- One handcart man's pocket cool bead sings; bakery worker uses a dry wooden bread paddle to move the pouch into ash. Exact later condition remains unknown.
- Charge weather wakes an old painted red-fish charm on the opposite board. No repair/investigation follows.
- A small boy named `Teren` runs with an active blue-hoop toy. Exact prose explicitly refuses to identify him with theatre Teren. Hoop arcs to a wet iron post, goes dark, and a lane worker later retrieves it. No injury or Greg intervention.
- Three short bell notes mean the front passed, not full infrastructure clearance. `Last chime means lines checked.` Exact operator/authority/procedure/universality remain unestablished.
- Greg waits for last chime and takes a longer flatter wet route home.
- Household grounding cord is newly noticed; wall light flickers once; Cala says `If twice, cover.` It stays stable. No repair case.
- No money, debt, job, Greg mana, theatre, ecology, holdfast, Lyssa-work, pressure, or injury change.

## Ch308 / Vale debt hour / possible cash work
- A Vale office boy delivers Antonius's optional debt-credit note at breakfast.
- Exact terms: Vale office; ground floor; one hour; seated; materials at table; cart covered; compare returned-goods tags against warehouse receipt list; mark MATCH / MISMATCH / UNREADABLE only; do not assign cause; credit one copper; reply yes/no.
- Greg accepts with `YES. ONE HOUR. IF MATERIALS ARE READY AS STATED.`
- First pass on nine tags yields five MATCH, two MISMATCH, two UNREADABLE.
- Clear mismatches remain `LAMP HOODS` vs `LAMP HOOKS` and receipt 463 vs tag 436 for `TWINE RINGS`.
- One BROWN BINDING tag has faint `R TO B` on the back. Antonius says his instruction was incomplete rather than blaming Greg.
- `R TO B` meaning remains unknown. Greg checks all backs; categories do not change.
...
- Cala independently goes out for an evening of cards with an unnamed older woman. Exact group/location/game/stakes/frequency remain unknown.
- Cala leaves bounded dinner ingredients and house-specific red-pot/heat-stone instructions.
...
- Object: palm-wide black iron round base, three folding teeth, thick top ring, dull amber bead, no release tongue, observed mark of three short lines crossed by one long line.
- Greg remembers later users calling the family `forty holds`; not established as formal present-day name.
- Broad known behavior: set on sufficiently solid surface, twist ring, teeth bite, item becomes extremely difficult to move relative to accepted surface for a fixed interval, then self-releases whether desired or not.
- Unnamed short-gray-haired seller understands the flaw and calls it the `bad one`. Provenance only `North storage` warehouse pullout.
- One demonstration establishes only this unit's observed set, resistance to seller's hard pull, three warning blinks, and self-release.
...
- Their magic creates pale offset copies. Greg tracks real feet/shadows.
- Renn initially draws a short sword; Greg and an older gray-braided cart woman get it sheathed and the lane quieted/opened.
...
- Ch293 brown leather shoulder bag remains regular equipment; existing narrow scrap/charcoal remain inside.
- Holdfast is stored at home rather than automatic daily carry.
- Ch308 Vale task is ground-floor/seated with covered transport; no body/equipment issue follows.
- Ch309 Greg shelters instead of racing farther and takes a longer flatter route home on wet stone; no injury.
...
- Rain shelf works. Front door repaired/functioning.
...
## Sevren / road continuity
- Sevren is an established earlier friend/courier with prior road/cart history with Greg. Ch311 is a long-delay return, not a new character introduction.
- Current established Ch311 changes: more east-relay work, less short city work, modified old courier bag, stated current road rhythm, and one completed half-day Three Wells ride with Greg as a non-working passenger.
...
- No bathhouse return, Noll meeting, accessibility project, maintenance work, or procedural body-care series.
...
- Ch284 chaffers remain separate.
- Ch292 shade fish remain separate.
...
## Older live threads
- Ch300 Vara/Ren/blue-horse bench-court outing stands complete.
- Ch299 Mera basket/Olan carry tie stands complete.
- Ch297 high line/Tess and Pella/Rusk/kessa jumpers stand; no return.
- Ch296 Nemi/workshop-court music stands; no music follow-up.
- Ch295 bridges/Vela/Orra/Demin/Sot stand; no return.
- Ch294 shopping/merchant-memory stands complete.
- Ch293 bag/stay bead functions normally.
- Ch292 shade fish/east-wall trough remain bounded.
- Ch291 door closer repair stands.
- Ch290 rain shelf works.
- Ch289 ward crossing repaired.
- Ch288 Miri/cooling-cup/Pellin route remains bounded.
- Ch287 carrying light/Sera stands.
- Ch286 dry seal remains resolved ordinary maintenance unless independently reactivated.
...
- Ch305 mirrorhorn route/origin/mechanism/regional variation remain bounded, while Greg's pre-charge field rule remains high-confidence without contrary evidence.
- Ch306 holdfast formal name, maker identity, age, load rating, duration, cooldown, service life, stone behavior, mechanism, future relation to `forty holds`, value, repair/recharge, and remaining activations remain bounded.
- Ch307 card-night older woman/group/location/game/stakes/frequency, returned-bowl sender/network, and heat-stone technical details remain bounded.
- Ch308 `R TO B` meaning, return-history cause, goods inspection outcomes, warehouse disposition, and mismatch causes remain unestablished. Permission for possible future cash-work terms is not a promised task.
- Ch309 charge-rain mechanism, frequency/severity, full city grounding network, bell authority, exact inspection methods, shelter identities, courier work, cool-bead condition, painted-fish charm, toy-hoop condition, child Teren identity, dark-lamp outcome, household ground-cord history, and wall-light flicker cause remain unestablished.
- Ch310 load-vest exact maker, age, formal load-line terminology, charm mechanism, safe load, anchor design, whether the line is damaged, whether thicker shirt is the only cause, final cloth alteration, and final customer satisfaction remain unestablished.
- Ch310 customer remains unnamed. Her job/employer, exact meaning of `I lift at first bell`, relationship to Jari, prior red carry-coat history, and whether she returns are unestablished.
- Jari remains only a name supplied for the prior alteration. Do not establish occupation, blame, relationship, or recurrence without new prose.
- Customer's offered extra bit does not establish a charm-line-work market rate. Lyssa's one-bit cloth price does not establish a universal tailoring rate.
- Lyssa's refusal establishes her scope/preference in this job, not a universal incapacity with charm-bearing garments.
...
- Antonius may send separate explicit cash-work terms only if a genuine task appears. Do not promote `may` into a guaranteed next beat.
