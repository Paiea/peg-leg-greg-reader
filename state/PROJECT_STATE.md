...
Current recorded story endpoint is Chapter 227 — **THE BUNDLER**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
