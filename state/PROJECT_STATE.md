...
Current recorded story endpoint is Chapter 229 — **THE ROAD ONE**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
