...
Current recorded story endpoint is Chapter 232 — **THE COUNTERSIGN**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
