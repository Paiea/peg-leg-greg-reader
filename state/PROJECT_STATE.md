...
Current recorded story endpoint is Chapter 245 — **THE NAME-TAKER**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
