...
Current recorded story endpoint is Chapter 237 — **THE BEARER**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
