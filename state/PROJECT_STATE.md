...
Current recorded story endpoint is Chapter 242 — **THE SPENDER**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
