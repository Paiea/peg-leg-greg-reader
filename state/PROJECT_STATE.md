...
Current recorded story endpoint is Chapter 239 — **THE MINDER**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
