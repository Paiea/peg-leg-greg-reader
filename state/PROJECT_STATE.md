...
Current recorded story endpoint is Chapter 235 — **THE TAGALONG**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
