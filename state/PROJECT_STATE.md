...
Current recorded story endpoint is Chapter 238 — **THE SEALER**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
