...
Current recorded story endpoint is Chapter 231 — **THE MAGISTRATE**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
