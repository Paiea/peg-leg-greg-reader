...
Current recorded story endpoint is Chapter 236 — **THE DISTRIBUTOR**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
