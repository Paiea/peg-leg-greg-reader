...
Current recorded story endpoint is Chapter 234 — **THE CONDITION**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
