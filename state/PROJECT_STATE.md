...
Current recorded story endpoint is Chapter 240 — **THE SAMPLE**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
