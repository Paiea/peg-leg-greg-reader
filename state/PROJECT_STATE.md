...
Current recorded story endpoint is Chapter 230 — **THE REPLICATE**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
