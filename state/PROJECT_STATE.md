...
Current recorded story endpoint is Chapter 233 — **THE SEAT**. Always verify `MANUSCRIPT_STATE.md` / running manuscript before using this number if newer work exists.
