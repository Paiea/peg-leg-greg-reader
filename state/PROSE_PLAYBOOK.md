...
Keep the camera close enough that observation feels like Greg noticing, not an omniscient report. Greg can be analytical without narrating every inference as a conclusion. Let physical detail, timing, discomfort, work, embarrassment, money, and other people's reactions carry meaning. Avoid turning intelligence into constant witty certainty.
...
This is particularly important for Lyssa. Preserve her independent work, errands, moods, obligations, competence, relationships, preferences, and desires. She is Greg's partner, not his narrative support device.

## Nicknames / running jokes / social labels

Nicknames should usually be socially earned, not author-assigned.
...
Worldbuilding should usually arrive because Greg is working, traveling, buying, rehearsing, testing, waiting, arguing, noticing, or needing something. Avoid encyclopedia paragraphs that stop the scene unless the information itself is the scene's pressure.
...
Make stage work concrete: entrances, exits, sightlines, props, furniture, cues, costumes, backstage traffic, audience timing, mistakes, recovery, and the difference between rehearsal and performance. Strongest performance beats may belong to other actors or the audience.

The theatre should read as both workplace and social organism. Let shorthand, favors, practical expertise, grudges, teasing, unofficial hierarchy, repeated mistakes, backstage routines, audience stories, and accumulated expectations survive between chapters.
...
Favor specific changed behavior and practical consequences over vague menace language. A supplier canceling, a question about money, a changed route, or a neighbor warning the theatre can carry more pressure than repeated declarations of danger.

## Editing across chapter boundaries

Do not treat every chapter as an isolated short story. Inspect neighboring chapters for repeated openings, duplicate jokes, emotional resets, forgotten social developments, roles that appeared once and vanished, nicknames that should plausibly persist, jokes that should die, and behavior that can accumulate rather than restart.
...
When repeated manuscript-wide weaknesses are discovered, add compact guidance here. Do not add one-off preferences unless they generalize.