...
- Chapters **1–5: VARIANCE REVIEWED**
- Chapters **6–320: NOT YET SEQUENTIALLY REVIEWED UNDER THE NEW VARIANCE ENGINE**
- Chapters **321–330: VARIANCE-REVIEWED OUT OF SEQUENCE AS PILOT/CONTINUATION WORK**
- Chapters **331–352: NOT YET VARIANCE REVIEWED**

Current sequential variance edge: **Chapter 6**

Latest sequential variance batch: `state/editorial/dialogue-variance-pass/BATCH_001_005.md`
...
Those later batches remain useful evidence but do not bridge the unreviewed 6–320 gap.
...
### 4. Relationship-specific rhythm
...
Resume sequentially at **Chapter 6**.

Preferred bounded queue: **5 chapters per batch** unless exact complexity justifies a smaller batch.

Next intended batch: **Chapters 6–10**.

## Restart prompt

`Continue PLG whole-manuscript dialogue + attribution pass from current GitHub authority on editor/voice-compression-pass, using the dialogue variance engine. Treat the dedicated dialogue variance ledger as the sequential authority and continue from its current edge.`