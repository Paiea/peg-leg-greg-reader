...
- When he is genuinely uncertain, let the pace narrow and simplify instead of performing uncertainty theatrically.
- **Dry humor** should usually be underplayed. Let the situation carry the joke.
...
- **Speaker clarity** outranks elegant ambiguity. If a listener could lose who owns a line, re-anchor naturally.
- Grief should not be signaled melodramatically before the words earn it.
- Do not overperform every joke, profanity, revelation, or emotional beat.
- Prefer scene-level dramatic truth over line-by-line tags such as `[sad]` or `[angry]`.
- Preserve useful silence and breath. Do not rush transitions simply because the text is short.
- The performance should feel like a strong traditional narrator who understands the scene, not generic text-to-speech.
