# GREG, AGAIN — CHAPTER 1 PROMISE LEDGER

Status: **ACTIVE WRITTEN EXPERIMENT / NON-CANON**

Source promise chapter:

`state/experiments/greg-again/prose/001-the-boy.md`

Purpose:

> **R2 is a short-horizon second run. Chapter 1 promises cannot be allowed to disappear merely because the local chapter engine is strong.**

This ledger is not an outline and not a checklist that forces a payoff on schedule.

It separates three things:

- **MUST REVISIT** — Chapter 1 loaded the reader strongly enough that R2 should return to it inside this run, even if the final payoff remains later or uncertain.
- **SHOULD ECHO** — useful continuity / world texture that should recur when organic, but does not deserve a forced subplot.
- **COLOR** — later-life texture or jokes that make Greg feel lived-in without creating a meaningful obligation.

A revisit is not the same thing as a payoff. A promise can become more complicated, be falsified, or prove to belong outside the one-year story horizon.

## Strong promises

### P01 — OLD SUPPORT EXPERTISE / LOST POWER

**Strength:** MUST REVISIT / CORE

Chapter 1 establishes that Greg ended his first life as one of seven S-class adventurers on the continent, specifically as support, after Barrier changed his path.
...
**Short-horizon obligation:**

- support must remain materially important to Greg's identity inside R2
- do not let the tiny-plane sequence become the entire support story
- revisit what becoming a support specialist actually meant, including people, institutions, costs, or choices around that path
- at least one later-life S-class connection / peer / rival / reputation thread should enter the living story before the run becomes too locally self-contained

**Do not:** rush old power back merely to satisfy the promise.

---

### P02 — KNOWING IS NOT DOING

**Strength:** MUST REVISIT / CORE ENGINE
...
### P03 — FUTURE AS LEAD, PRESENT AS PROOF

**Strength:** MUST REVISIT / GOVERNING PROMISE

Chapter 1 explicitly states:
...
Greg's future knowledge must sometimes produce real leverage, not only be wrong. It must also remain vulnerable to missing chronology and false causal stories.

---

### P04 — PEOPLE / ORDINARY LIFE LOST FROM MEMORY

**Strength:** MUST REVISIT / EMOTIONAL CORE
...
**Short-horizon obligation:** do not make Mara the only proof. Other pieces of young Greg's life should occasionally know him better than he knows himself.

The point is not a memory scavenger hunt. The point is that history and affection preserve different things.

---

### P05 — MARA'S LETTER

**Strength:** MUST REVISIT
...
**Remaining obligation:** consequences may continue through letters and changed lives, but Chapter 1's immediate promise has been honored. Do not keep Mara in Carrow by narrative gravity.

---

### P06 — NORTHERN GATE COLLAPSE

**Strength:** MUST REVISIT / LONG SHADOW
...
**Short-horizon obligation:** keep the thread alive without solving it immediately. Before R2 ends, the book should materially update Greg's belief about what the remembered collapse actually was, when it happened, or what caused it.
...
Do not manufacture an immediate arson plot merely because the promise exists.

---

### P08 — RIVER SHIPPING / FUTURE MERCHANT WEALTH
...
### P09 — SOREN / THE RED WINTER

**Strength:** MUST REVISIT

Chapter 1 asks whether Soren died in the Red Winter or whether Greg only remembers meeting him later with a scar he claimed came from there.
...
Do not force Soren into the next chapter merely to clear the ledger.

---

### P10 — FUTURE PEOPLE, PROFESSIONS, DISCOVERIES, WARS, GUILD FAILURES, MONSTERS

**Strength:** MUST REVISIT / BROAD PROMISE
...
Greg's knowledge should sometimes earn a real advantage so the premise retains temptation.

---

### P11 — ONE OF SEVEN S-CLASS ADVENTURERS
...
Do not assemble the whole team early.

---

### P12 — THE SECOND LETTER

**Strength:** MUST REVISIT / OBJECT PROMISE
...
### P13 — THE BENT LOCKPICK

**Strength:** SHOULD REVISIT / YOUNG-GREG CLUE
...
## Medium-strength echoes

### E01 — THE SIEGE OF EAST VERREL

Greg uses East Verrel as a historical dating anchor.

This establishes that later public memory can feel more reliable than Greg's personal chronology.

**Current posture:** SHOULD ECHO when war chronology or public historical memory becomes relevant. The siege itself does not require an R2 payoff unless its date falls inside the run.

### E02 — CARROW BECAME A DIFFERENT CITY

The missing Exchange, absent apothecary, mud where Greg remembers paving, replaced buildings, changed names, and later plaques all establish Carrow as a historical process rather than a static setting.

**Current posture:** SHOULD ECHO through construction, businesses, institutions, neighborhoods, and people changing while Greg is present. Do not preserve Carrow as a stage set.

### E03 — THE GUILD RESISTS GREG IN BOTH LIVES

Chapter 1 ends by choosing the Guild because Greg learned that systems reveal themselves where they resist.

**Current posture:** ACTIVE. Sella, access costs, contracts, rankings, staff drills, and city work have paid this. Keep institutional friction specific rather than turning the Guild into generic quest infrastructure.

### E04 — MONEY, BODY, MAGIC, MEMORY ALL RESIST

Chapter 1 explicitly groups these as systems Greg cannot simply command.

**Current posture:** ACTIVE / HEALTHY. Continue letting which resistance dominates change with time.

### E05 — PARENTS REMAIN DEAD

The reset stops short of Greg's parents. That is not a mystery to solve.

**Current posture:** emotional truth, not plot debt. Their absence should continue to shape ordinary memory and second-life choices when relevant without turning into resurrection bait.

---

## Color, not debt

The following currently read as later-life texture unless another scene gives them new causal weight:

- Red Hollow and Greg's badly reset finger
- the duke's son and the dining table
- dragon nests as evidence of Greg's later career
- the grammar-correcting necromancer
- specific old aches and scars
- Soap Thief as an individual person, because Mara / Tavin already carry the stronger ordinary-memory promise

They may return. They do not need to.

## Promise cadence for a short R2

R2 should not wait hundreds of chapters to remember its opening.

At roughly each **five-chapter frontier**, glance at this ledger and ask only:

1. Has any MUST REVISIT promise gone inert long enough to feel forgotten?
2. Can a current causal event naturally update one of them?
3. Are we paying too many promises at once and making the book feel engineered?
4. Has new prose created a stronger promise that belongs beside these?
