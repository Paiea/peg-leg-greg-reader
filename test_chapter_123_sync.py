...
for chapter in range(106, 124):
    ...
    if chapter < 123:
        ...
        assert "124.html" not in parser.links, "Chapter 123 must be the published endpoint"
...
print("Chapter 123 synchronization checks pass")
