...
for chapter in range(106, 156):
    ...
    if chapter < 155:
        ...
        assert "156.html" not in parser.links, "Chapter 155 must be the published endpoint"
...
print("Chapter 155 synchronization checks pass")
