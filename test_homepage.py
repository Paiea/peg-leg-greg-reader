...
expect(len(re.findall(r'href="chapters/\d{3}\.html"', html)) == 153, 'expected 152 TOC links plus Begin Reading')
expect('href="chapters/152.html"' in html, 'chapter list must reach Chapter 152')
