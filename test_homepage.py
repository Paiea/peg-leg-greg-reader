...
expect(len(re.findall(r'href="chapters/\d{3}\.html"', html)) == 114, 'expected 113 TOC links plus Begin Reading')
expect('href="chapters/113.html"' in html, 'chapter list must reach Chapter 113')
