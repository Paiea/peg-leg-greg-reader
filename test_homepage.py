...
expect(len(re.findall(r'href="chapters/\d{3}\.html"', html)) == 156, 'expected 155 TOC links plus Begin Reading')
expect('href="chapters/155.html"' in html, 'chapter list must reach Chapter 155')
