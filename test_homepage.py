...
expect(len(re.findall(r'href="chapters/\d{3}\.html"', html)) == 138, 'expected 137 TOC links plus Begin Reading')
expect('href="chapters/137.html"' in html, 'chapter list must reach Chapter 137')
