...
class ThirdLegSiteTests(unittest.TestCase):
    def test_site_files_and_identity(self):
        ...
        self.assertIn('class="hero-dragon-stage"', html)
        self.assertIn('class="hero-dragon-art"', html)
        self.assertIn('src="assets/images/hero/dragon-bargain.png"', html)
    ...
    def test_audio_library_is_a_clean_listening_page(self):
        ...
        self.assertIn('class="audio-library-showcase"', audio)
        self.assertIn('src="../assets/images/audio/audio-library.png"', audio)
    ...
    def test_record_001_is_published_for_listen_and_read(self):
        ...
        asset_path = ROOT / "3l" / "assets" / "audio" / "record-001-headspace-v6.mp3"
        ...
        self.assertIn('../assets/audio/record-001-headspace-v6.mp3', record)
    ...
    def test_records_002_and_003_are_published_for_listen_and_read(self):
        ...
        for number, title in (("002", "THE CLAIMANT"), ("003", "THE BARGAINER")):
