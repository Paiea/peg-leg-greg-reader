...
class PLGAIToolTests(unittest.TestCase):
    ...
    def test_apply_survivors_is_the_only_write_adapter_and_delegates(self):
        write_tools = {name for name, spec in plg_ai_tools.TOOL_SPECS.items() if spec["write"]}
        self.assertEqual({"apply_survivors"}, write_tools)
