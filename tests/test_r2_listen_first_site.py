...
class R2ListenFirstSiteTests(unittest.TestCase):
    def test_home_prefers_listening_and_uses_current_banner(self):
        html = (R2 / 'index.html').read_text(encoding='utf-8')
        self.assertIn('assets/images/1.png', html)
        self.assertNotIn('assets/images/r2-hero-wide.webp', html)
        self.assertNotIn('assets/images/r2-hero-portrait.webp', html)
