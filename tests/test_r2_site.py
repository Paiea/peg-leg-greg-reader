...
class R2SiteTests(unittest.TestCase):
    def test_project_manifest_names_run_two_and_preserves_run_one(self):
        ...
        self.assertEqual(project['current_chapter'], 'r2-ch026')
    ...
    def test_written_frontier_is_public_through_chapter_twenty_six(self):
        for number in range(1, 27):
            ...
            self.assertEqual(
                ...
                None if number == 26 else f'r2-ch{number + 1:03d}',
            )
