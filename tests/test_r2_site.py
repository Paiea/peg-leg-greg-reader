...
class R2SiteTests(unittest.TestCase):
    def test_project_manifest_names_run_two_and_preserves_run_one(self):
        ...
        self.assertEqual(project['chapters'], [f'r2-ch{i:03d}' for i in range(1, 35)])
        self.assertEqual(project['current_chapter'], 'r2-ch034')
    ...
    def test_written_frontier_is_public_through_chapter_thirty_four(self):
        for number in range(1, 35):
            ...
            self.assertEqual(
                ...
                None if number == 34 else f'r2-ch{number + 1:03d}',
            )
