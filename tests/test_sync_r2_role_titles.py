...
class R2RoleTitleSyncTests(unittest.TestCase):
    def make_fixture(self, root: Path):
        ...
        write_json(root / "r2" / "data" / "project.json", {"chapters": ["r2-ch001", "r2-ch002"]})
        write_json(root / "r2" / "data" / "chapters" / "ch001.json", {
            "chapter_id": "r2-ch001", "display_number": 1, "title": "Old One",
            "route": "chapter.html?ch=1", "written": {"path": "assets/written/ch001.md"},
        })
        write_json(root / "r2" / "data" / "chapters" / "ch002.json", {
            "chapter_id": "r2-ch002", "display_number": 2, "title": "Two Things",
            "route": "chapter.html?ch=2", "written": {"path": "assets/written/ch002.md"},
        })
        write_json(root / "r2" / "data" / "chapter-registry.json", {
            "chapters": {"r2-ch001": {"display_number": 1, "title": "Old One", "status": "published"}}
        })
        write_json(root / "greg-again" / "audio" / "manifest.json", {
            "chapters": [
    ...
    def test_promote_audit_preserves_heading_prefixes_and_prose(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertEqual((root / "r2/assets/written/ch001.md").read_text(), "# Chapter 1: The Boy\n\nBody one stays exact.\n")
            self.assertEqual((root / "r2/assets/written/ch002.md").read_text(), "# Year Chapter 01: The Novice\n\nBody two stays exact.\n")
